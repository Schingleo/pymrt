"""Test for mayavi package installation

This sample code generates a structured grid using numpy arrays and visualized with mayavi2 application.
The source code comes from http://docs.enthought.com/mayavi/mayavi/auto/example_structured_grid.html
