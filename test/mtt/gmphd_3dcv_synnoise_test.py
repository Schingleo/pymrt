...
def load_3dcv_states(model):
    states_chk_point = os.path.join(chkpt_dir, "3dcv_noise_states.pkl")
...
def load_3dcv_observation(model, truth):
    observation_chk_point = os.path.join(chkpt_dir,
                                         "3dcv_noise_observation.pkl")
...
if __name__ == "__main__":
    ...
    result_filename = os.path.join(chkpt_dir, 'gmphd_3dcv_noise_chkpt.pkl')
